...
$category_id | ID категории. Вы получите записи из текущей категории или всей ветки текущей категории в зависимости от настроки раздела "Режим статей" 
your section
 or category "Records mode" 
parameter.
