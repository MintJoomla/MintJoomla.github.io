...
<div class="box-hint">This is ongoing article. I'll add here small tricks and tips along the way. Please follow/subscribe this article to get alerts when I edit this article</div>
...
I do not recommend to call this in list and full article templates as this method require some additional SQL queries to load field and all fields already loaded there. You can use it in cases where record fields are not accessible.
